export default [{
  ...
  songs: [
    ...
    slug: 'the-telephone',
    songs: [
      { title: 'Calls', duration: '161.71', audioSrc: '/assets/music/blue.mp3' },
      { title: 'Voice', duration: '103.96', audioSrc: '/assets/music/green.mp3' },
      { title: 'Mail', duration: '268.45', audioSrc: '/assets/music/red.mp3' },
      { title: 'Texts', duration: '153.14', audioSrc: '/assets/music/pink.mp3' },
      { title: 'No', duration: '374.22', audioSrc: '/assets/music/magenta.mp3' }
    ]
}];
